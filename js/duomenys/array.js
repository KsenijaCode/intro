/* 
ARRAY - masyvas, sąrašas, list'as, matrica, kolekcija
*/
...
//              0, 1, 2, 3, 4, ...      pozicijos skaiciuojamos nuo 0
...
let sum3 = 0;                   // ne const
let index = 0;                  // index - pozicijos nr.
...
sum3 = sum3 + marks[0];         // sum3 += marks[0]
sum3 = sum3 + marks[1];         // sum3 += marks[1]
sum3 = sum3 + marks[2];         // sum3 += marks[2]
sum3 = sum3 + marks[3];         // sum3 += marks[3]
sum3 = sum3 + marks[4];         // sum3 += marks[4]
